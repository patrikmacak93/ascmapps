/*
============================================================
VSTUPNI BOD BACKENDU APLIKACE WAREHOUSE-HLADINY
============================================================
Co dela:
...
proxuje /warehouseHladiny/* na http://localhost:<PORT>
(URL Rewrite v rootovem web.config).
*/
...
console.log(`Warehouse-hladiny backend bezi na http://localhost:${config.PORT}`);
